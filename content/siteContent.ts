export const siteContent = {
  ...
  about: {
    ...
    slogans: [
      ...
      "Kružni tok ravnoteže počinje dodirom.",
      "Prvi korak ne mora biti velik. Samo stvaran.",
    ],
  },
  services: {
    pageTitle: "Usluge",
  ...
  space: {
    title: "Prostor & Oprema",
    description:
      "Studio se nalazi u mirnom dijelu Maksimira, lako dostupan automobilom i javnim prijevozom. Prostor je intiman, dizajniran s namjerom i u potpunosti posvećen klijentu u svakom trenutku.",
    location: "Ulica Ivana Rendića 29, Zagreb",
    features: [
      "Intiman i miran prostor",
      "Profesionalna oprema",
      "Visoki standardi higijene",
